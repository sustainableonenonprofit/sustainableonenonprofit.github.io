...
<html>
  <head>
    <title>Sustainable One Footer</title>
    <meta charset = "UTF-8" />
  ...
  <form action="https://icloud.us3.list-manage.com/subscribe/post?u=50626d56b462133568453e229&amp;id=127c265c42" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
      <div id="mc_embed_signup_scroll">
  	<label for="mce-EMAIL">Subscribe to our newsletter</label>
  	<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required>
      <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
      <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_50626d56b462133568453e229_127c265c42" tabindex="-1" value=""></div>
